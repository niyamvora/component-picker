...
import { assembleSelection, sectionRows } from "./drawer-sections";
...
declare global {
  interface Window {
    ...
    __cp?: {
      ...
      ui: { sectionRows: typeof sectionRows; assemble: typeof assembleSelection };
    };
...
if (window.__cp) {
  ...
  window.__cp = {
    ...
    ui: { sectionRows, assemble: assembleSelection },
  };
